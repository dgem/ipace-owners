...
Choose every outcome you would support and, if you wish, mark your preferred option. Results remain hidden until you submit. You can change your answers until the survey closes.

## The evidence owners have built together
...
Since the group launched on **17 July 2026**, **{{membersJoined}} owners have joined**. Together, members have recorded **{{vehiclesRegisteredCount}} cars**, **{{vehiclesSoHReadingsCount}} battery-health readings** and **{{serviceFaultRecordsCount}} service and fault records**.

The survey will help us explain which outcomes owners support, while the vehicle history shows the real effects of battery faults, recalls, repairs and delays.

[Add my vehicle history](https://ipace-owners.org/member/dashboard/){.button}

Already answered? Thank you. This reminder is sent only to members who had not submitted when the audience was checked. If you have just answered, there is nothing else you need to do.

## Help another owner respond in time
