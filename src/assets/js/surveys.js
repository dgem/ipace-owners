(function () {
  ...
  document.querySelectorAll('[data-survey-admin]').forEach(setupAdmin); document.querySelectorAll('[data-member-survey-list]').forEach(setupMemberList); document.querySelectorAll('[data-member-survey-response]').forEach(setupResponse);
