...
| `GET /api/admin/stats` | `AdminStats` | Admin | Return aggregate member, vehicle, SoH, and service-event statistics for the admin dashboard with `Cache-Control: private, no-store`. |
