...
| `GET /api/admin/survey-results` | `AdminSurveyResults` | Admin | Return aggregate and individual survey responses for manual analysis; `format=csv` exports masked, PII-minimised rows. |
