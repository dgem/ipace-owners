...
| `POST /api/admin/marketing-message-templates` | `AdminMarketingMessageTemplates` | Admin | Load source-controlled prepared broadcasts (September survey, JLR update, member referral and growth drive), filling public evidence totals server-side. |
